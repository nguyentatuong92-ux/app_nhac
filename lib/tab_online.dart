              ...
              : ValueListenableBuilder<int>(
                  ...
                  builder: (context, currentIndexValue, child) {
                    return ValueListenableBuilder<String>(
                      ...
                      builder: (context, queueType, child) {
                            ...
                            return ListTile(
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    tooltip: "Thêm vào danh sách Online",
                                    onPressed: () {
                              ...
                              onTap: () async {
                                ...
                                await OnlineMusicController.playSong(
                                  ...
                                  context,
                                  customQueue:
                                      OnlineMusicController.searchResults,
                                  queueType: "search",
                                );
                                ...
                                // THÊM: Chuyển màn hình khi phát nhạc
                                if (context.mounted) {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
